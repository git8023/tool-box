export declare namespace vmsNet {
    /**
     * GET 请求参数
     *
     ...
     * @function
     */
    interface Parameters<P = void, PV = void> {
        /**
         * 路径变量
         * @example
         *
     ...
     * @function
     */
    interface GetMapping<R = void, P = void, PV = void> {
     ...
     * @function
     */
    interface PostMapping<R = void, P = void, PV = void> extends GetMapping<R, P, PV> {
    }
}
